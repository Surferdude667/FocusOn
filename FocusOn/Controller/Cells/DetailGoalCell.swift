...
class DetailGoalCell: UITableViewCell {
    ...
    func setGoalCheckMark() {
        if goal.completed {
            goalCheckmarkImage.image = #imageLiteral(resourceName: "checkmark.pdf")
            goalCheckmarkImage.tintColor = #colorLiteral(red: 0.1959999949, green: 0.8429999948, blue: 0.2939999998, alpha: 1)
            goalTitleLabel.textColor = #colorLiteral(red: 0.1959999949, green: 0.8429999948, blue: 0.2939999998, alpha: 1)
        } else {
            goalCheckmarkImage.image = #imageLiteral(resourceName: "circle.pdf")
            goalCheckmarkImage.tintColor = #colorLiteral(red: 1, green: 0.2160000056, blue: 0.3729999959, alpha: 1)
